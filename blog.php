      ...
      <?php
       ...
       ?>
        <div class="page-title">
            <div class="single-slider slider-height slider-height-breadcrumb d-flex align-items-center" style="background-image: url(admin/uploads/<?= $data['blog_ban_photo']; ?>);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider-content slider-content-breadcrumb text-center">
                                <h1 class="white-color f-700"><?= $data['blog_ban_title']; ?></h1>
    ...
    <div class="blog-grid-area gray-bg pt-100 pb-70">
        <div class="container">
            <div class="blog-grid-list">
                <div class="row">
                  <?php
                   $sel="SELECT * FROM blog_details ORDER BY blog_det_id DESC LIMIT 0,9";
                   $Q=mysqli_query($con,$sel);
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="blog-wrapper mb-30">
                            ...
                            <div class="blog-content">
                                ...
                                <p><?= substr($data['blog_det_subtitle'],0,60); ?></p>
