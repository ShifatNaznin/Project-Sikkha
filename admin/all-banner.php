    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        ...
        <div class="col-md-3 text-right">
          <a href="add-banner.php" class="btn btn-sm btn btn-primary"><i class="fa fa-plus-circle"></i> Add Home Banner</a>
        </div>
              ...
              <tr>
                    ...
                    <td class="hidden-xs">
                      ...
                      if(!empty($data['ban_photo'])){
                        ?>
                        <img height="50" src="uploads/<?=$data['ban_photo'];?>" alt="photo"/>
                        <?php
                      }else{
                        ?>
